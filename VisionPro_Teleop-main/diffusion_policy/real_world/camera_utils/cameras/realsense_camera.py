...
class RealSenseCamera(CameraDriver):
    ...
    def read(
        ...
        for i, frameset in enumerate(framesets):
            ...
            capture_time = depth_frame.get_timestamp() / 1000
        ...
        return image, depth, capture_time